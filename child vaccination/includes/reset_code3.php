  ...
  <div class="container-fluid">
    <div class="row p-3 align-items-center justify-content-center" style="height: 100vh;">
      <div class="col-md-4 bg-light shadow border border-gray p-5">
        <form action="reset_code3.php" method="POST" autocomplete="off">
          ...
          <div class="form-group">
            <input class="form-control button btn-main mb-3" type="submit" name="check-admin-reset-otp" value="Submit">
