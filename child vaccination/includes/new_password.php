      ...
      <div class="col-md-4 bg-light shadow border border-gray p-5">
        <form action="new_password.php" method="POST" autocomplete="off">
          ...
          <div class="form-group">
            <input class="form-control button btn-main mb-3" type="submit" id="submit-pass" name="change-password"
              value="Change">
            <a href="reset_otp.php?email=<?php echo $email ?>" class="btn btn-outline-main col-12">Cancel</a>
          </div>
        </form>
      </div>
    </div>
