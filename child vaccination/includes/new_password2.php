  ...
  <div class="container">
    <div class="row p-3 align-items-center justify-content-center" style="height: 100vh;">
      <div class="col-md-4 bg-light shadow border border-gray p-5">
        <form action="new_password2.php" method="POST" autocomplete="off">
          ...
          <div class="form-group">
            <input class="form-control button btn-main mb-3" type="submit" id="submit-pass"
              name="change-secretary-password" value="Change">
