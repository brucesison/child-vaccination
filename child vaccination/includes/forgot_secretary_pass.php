  ...
  <div class="container-fluid">
    <div class="row p-3 align-items-center justify-content-center" style="height: 100vh;">
      <div class="col-md-4 bg-light shadow border border-gray p-5">
        <form action="forgot_secretary_pass.php" method="POST" autocomplete="">
          ...
          <div class="form-group mb-4">
            <input class="form-control button btn-main" type="submit" name="check-secretary-email" value="Continue">
          </div>
          <div class="col-md-12 text-center">
            Back to
            <a href="secretary_login.php" class="text-main font-weight-bold">login</a>
          </div>
        </form>
      </div>
    </div>
