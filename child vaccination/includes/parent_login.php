...
if (!isset($_SESSION['parent_loggedin'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $select = "SELECT * FROM user_tbl WHERE email = :email AND pass = :pass";
        ...
        if ($stmt->rowCount() > 0) {
            ...
            $_SESSION['parent_name'] = $row['u_fname'] . ' ' . $initials . ' ' . $row['u_lname'];
...
<body id="page-top" class="login_body">
    ...
    <div class="container-fluid px-4 pt-4">
        <div class="row p-3 align-items-center justify-content-center" style="height: 100vh;">
            <div class="col-md-5 bg-light pt-5 border rounded d-flex align-items-center justify-content-center container-relative"
                data-aos="zoom-out" data-aos-delay="300">
                <dotlottie-player src="../staff/img/teddybear.json" class="teddy-top-left" background="transparent"
                    speed="1" loop style="height: 100px; width: 100px" autoplay></dotlottie-player>
                <form id="login_form" method="POST" action="" class="m-0">
                    ...
                    <div class="d-flex justify-content-center mb-3">
                        <button type="submit" class="col-md-7 btn btn-outline-main btn-block font-weight-bold"
                            name="submit_form" id="login-btn" value="Log in" title="Sign In">Sign In</button>
                    </div>
                    ...
                    <div class="text-center mb-3">
                        <a href="register.php" class="text-main small">Create an account!</a>
