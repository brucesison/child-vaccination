<div class="modal fade" id="add_secretary" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
  aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header border-bottom-main">
        <h5 class="modal-title text-dark text-uppercase" id="exampleModalLabel">Add Secretary</h5>
      </div>
      <form id="add_secretary_form" action="add/add_secretary.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-8">
                <div class="row">
                  ...
                  <div class="col-md-12 mb-3">
                    <p class="mb-1 small text-center">Secretary profile picture</p>
