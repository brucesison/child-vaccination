<div class="modal fade" id="edit_admin" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
  aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header border-bottom-main">
        <h5 class="modal-title text-dark text-uppercase" id="exampleModalLabel">Edit Profile</h5>
      </div>
      <form id="update_details_form" action="edit/edit_a_details.php" method="POST" enctype="multipart/form-data">
        <input type="hidden" id="default_contact_no" value="<?php echo $staff_info['contact_no']; ?>">
        <input type="hidden" id="default_email" value="<?php echo $staff_info['email']; ?>">
        <input type="hidden" name="staff_id" value="<?php echo $staff_info['staff_id']; ?>">
        <div class="modal-body bg-light">
          ...
          <div class="row mb-4">
            <div class="col-md-4">
              ...
              <input class="form-control border border-secondary" name="s_fname" type="text"
                value="<?php echo $staff_info['s_fname']; ?>" required minlength="3" maxlength="15"
            ...
            <div class="col-md-4">
              ...
              <input class="form-control border border-secondary" name="s_m_initial" type="text"
                value="<?php echo $staff_info['s_m_initial']; ?>" required minlength="3" maxlength="20"
                pattern="[A-Za-z\s]+" title="Only alphabetic characters are allowed">
            </div>
            <div class="col-md-4">
              ...
              <input class="form-control border border-secondary" name="s_lname" type="text"
                value="<?php echo $staff_info['s_lname']; ?>" required minlength="5" maxlength="15"
                pattern="[A-Za-z\s]+" title="Only alphabetic characters are allowed">
            </div>
          </div>
          ...
          <div class="input-group mb-4">
            ...
            <input class="form-control border border-secondary" id="contact_no" name="contact_no" type="text"
              placeholder="9912367..." value="<?php echo $staff_info['contact_no']; ?>" placeholder="991236...."
          ...
          <div class="mb-3">
            ...
            <input class="form-control border border-secondary" id="email" name="email" type="email"
              value="<?php echo $staff_info['email']; ?>" placeholder="Input gmail" required minlength="13"
              maxlength="50">
          </div>
        </div>
