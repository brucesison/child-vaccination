<div class="modal fade" id="delete_parent" tabindex="-1" data-backdrop="static" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="delete_parent_form" action="delete/delete_parent2.php" method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-danger" id="delete-btn"><i
...
<?php include './includes/delete_process.php'; ?>
...
<script>
    $(document).ready(function () {
        $('#delete-btn').click(function (event) {
            ...
            var form = document.getElementById('delete_parent_form');
            ...
            $('#deleting-process').css('display', 'flex').fadeIn('fast');
