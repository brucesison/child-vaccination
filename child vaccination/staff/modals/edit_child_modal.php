<div class="modal fade" id="edit_child" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <form id="update_child_form" action="edit/edit_child.php" method="POST">
