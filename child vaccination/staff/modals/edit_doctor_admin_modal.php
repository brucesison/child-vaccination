<div class="modal fade" id="edit_admin" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="update_details_form" action="edit/edit_da_details.php" method="POST" enctype="multipart/form-data">
        <input type="hidden" id="default_contact_no" value="<?php echo $doctor_admin['contact_no']; ?>">
        <input type="hidden" id="default_email" value="<?php echo $doctor_admin['email']; ?>">
        ...
        <div class="modal-body bg-light">
          ...
          <div class="row mb-4">
            <div class="col-md-4">
              ...
              <input class="form-control border border-secondary" name="s_fname" type="text"
                value="<?php echo $doctor_admin['s_fname']; ?>" required minlength="3" maxlength="15"
            ...
            <div class="col-md-4">
              ...
              <input class="form-control border border-secondary" name="s_m_initial" type="text"
                value="<?php echo $doctor_admin['s_m_initial']; ?>" required minlength="3" maxlength="20"
                pattern="[A-Za-z\s]+" title="Only alphabetic characters are allowed">
            </div>
            <div class="col-md-4">
              ...
              <input class="form-control border border-secondary" name="s_lname" type="text"
                value="<?php echo $doctor_admin['s_lname']; ?>" required minlength="3" maxlength="15"
                pattern="[A-Za-z\s]+" title="Only alphabetic characters are allowed">
            </div>
          </div>
          <div class="input-group mb-4">
            ...
            <input class="form-control border border-secondary" id="contact_no" name="contact_no" type="text"
              placeholder="9912367..." value="<?php echo $doctor_admin['contact_no']; ?>" placeholder="991236...."
          ...
          <div class="mb-3">
            ...
            <input class="form-control border border-secondary" id="email" name="email" type="email"
              value="<?php echo $doctor_admin['email']; ?>" placeholder="Input gmail" required minlength="13"
              maxlength="50">
          </div>
        </div>
