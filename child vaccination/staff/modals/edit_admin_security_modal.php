<div class="modal fade" id="edit_admin_security" data-backdrop="static" data-keyboard="false" tabindex="-1"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="edit/edit_a_pass.php" method="POST">
        ...
        <div class="modal-body bg-light">
          ...
          <div class="col-md-12 mb-3">
            <div class="input-group">
              <input class="form-control border border-secondary" id="pass" name="pass" type="password"
            ...
            <div id="password-strength-alert" class="text-danger mt-2" style="display: none;">Password must be at least
              8 characters long and contain at least one number, and one special character.</div>
          </div>
          <div class="col-md-12 mb-3">
            <div class="input-group">
              <input class="form-control border border-secondary" id="cpass" name="cpass" type="password"
