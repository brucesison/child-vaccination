...
if (!isset($_SESSION['admin_loggedin']) && !isset($_SESSION['secretary_loggedin'])) {
    ...
    if (isset($_GET['staff_id'])) {
        $secretary = $functions->getThisSecretary($_GET['staff_id']);

        $s_m_name = $secretary['s_m_initial'];
    ...
    if ($current_page == 'view_secretary.php') {
...
<head>
    ...
    <title><?php echo $secretary['s_fname'] . ' ' . $initials1 . ' ' . $secretary['s_lname'] . "'s Profile"; ?></title>
                ...
                <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-light small shadow">
                            <li class="breadcrumb-item"><a class="text-main" href="list_secretary_table.php">Secretary
                                    list</a></li>
                            <li class="breadcrumb-item active" aria-current="page">View secretary</li>
                        </ol>
                    </nav>
                    ...
                    <div class="row my-5 d-flex h-100">
                        <div class="col-md-4 mb-4">
                            <div class="card shadow">
                                ...
                                <!-- change photo modal -->
                                <?php include 'modals/change_secretary_p_modal.php'; ?>

                                <!-- view admin photo modal -->
                                <?php include 'modals/view_secretary_pic_modal.php'; ?>

                                <div class="card-body text-center">
                                    <div class="mt-3 mb-1">
                                        <!-- image profile -->
                                        <img src="<?php echo htmlspecialchars($secretary['staff_pic']); ?>"
                                            class="rounded-circle img-fluid border p-2 parent-pic"
                                            style="width: 100px; height: 100px" data-toggle="modal"
                                            data-target="#view_secretary_pic" />
                                    </div>
                                    <p class="text-xs text-main change-photo font-weight-bold mb-3" data-toggle="modal"
                                        data-target="#change_photo_doctor">Change Photo</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                            ...
                                            <button class="dropdown-item" data-toggle="modal"
                                                data-target="#edit_secretary">Edit</button>
                                            <button class="dropdown-item" data-toggle="modal"
                                                data-target="#edit_secretary_security">Security</button>
                                            <div class="dropdown-divider"></div>
                                            <button class="dropdown-item-delete" data-toggle="modal"
                                                data-target="#delete_secretary">Delete</button>
                                        </div>
                                    </div>
                                </div>

                                <!-- edit secretary details modal -->
                                <?php include 'modals/edit_secretary_modal.php'; ?>

                                <!-- edit secretary pass modal -->
                                <?php include 'modals/edit_secretary_security_modal.php'; ?>

                                <!-- delete secretary modal -->
                                <?php include 'modals/delete_secretary_modal.php'; ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control bg-light text-muted"
                                                    ...
                                                    value="<?php echo $secretary['s_fname'] . ' ' . $initials1 . ' ' . $secretary['s_lname']; ?>"
                                                    disabled>
                                            </div>
                                            <div class="col-md-6">
                                                <p class="text-gray small mb-1 mt-3">Email</p>
                                                <input type="text" class="form-control bg-light text-muted"
                                                    style="font-size: 13px;" value="<?php echo $secretary['email']; ?>"
                                                    disabled>
                                            </div>
                                            <div class="col-md-6 mb-1">
                                                ...
                                                <input type="text" class="form-control bg-light text-muted"
                                                    style="font-size: 13px;"
                                                    value="0<?php echo $secretary['contact_no']; ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
