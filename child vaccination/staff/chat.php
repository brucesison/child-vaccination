            ...
            <section class="chat-area col-md-12">
              <header>
                ...
                if ($user_id) {
                  ...
                  $sql = "SELECT * FROM user_tbl WHERE unique_id = :user_id";
                ...
                <img src="<?php echo $row['profile_image']; ?>" class="rounded-circle" alt="Doctor Picture">
                <div class="details">
                  <?php
                  ...
                  ?>
                  <span><?php echo $row['u_fname'] . ' ' . $initials . ' ' . $row['u_lname']; ?></span>
                  <p><?php echo $row['session_status']; ?></p>
                </div>

                <?php $room_name = rand(time(), 100000000);
                $_SESSION['room_name'] = $room_name; ?>
                <form class="ml-auto" action="add/add_meetlink.php" method="POST">
                  <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
                  <input type="hidden" name="unique_id" value="<?php echo $unique_id; ?>">
                  <input type="hidden" name="msg" value="https://meet.jit.si/<?php echo $room_name; ?>">
                  <button class="btn" type="submit"><i class="fas fa-fw fa-video text-main"></i></button>
                </form>
