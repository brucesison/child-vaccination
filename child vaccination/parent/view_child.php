...
<head>
    ...
    <title><?php echo $child['c_fname'] . ' ' . $initials . ' ' . $child['c_lname']; ?>' Profile</title>
                                    ...
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                            ...
                                            <button class="dropdown-item" data-toggle="modal"
                                                data-target="#edit_my_child">Edit</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <p class="text-gray small mb-1 mt-3">Marks</p>
                                                <input type="text" class="form-control bg-light text-muted"
                                                    style="font-size: 13px;" value="<?php echo $child['marks']; ?>"
                                                    disabled>
                                            </div>
                                        </div>
                                    </div>
