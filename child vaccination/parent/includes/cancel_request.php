...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  try {
    ...
    $mail->Subject = 'Appointment Request Cancelled';
    $mail->Body = "$parent_name cancel appointment request on $appointment_date. Reason: $cancel_reason";
    $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';

    $mail->send();


    header("Location: ../app_request.php?status=cancelled");
    exit();
