<div class="modal fade" id="change_my_photo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="edit/edit_my_photo.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <!-- <div class="col-md-12 border border-main p-0 rounded mb-3">
              <input class="d-none border border-main" id="file-input" name="profile_image" type="file" accept="image/*" required>
              <label for="file-input" class="btn btn-main mr-2 file-label">
