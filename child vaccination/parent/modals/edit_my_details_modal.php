<div class="modal fade" id="edit_my_profile" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
  aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header border-bottom-main">
        <h5 class="modal-title text-dark text-uppercase" id="exampleModalLabel">Edit My Info</h5>
      </div>
      <form id="update_details_form" action="edit/edit_my_details.php" method="POST" enctype="multipart/form-data">
        <input type="hidden" id="default_contact_no" value="<?php echo $parent_info['contact_no']; ?>">
        <input type="hidden" id="default_email" value="<?php echo $parent_info['email']; ?>">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 mb-3">
                    <input class="form-control border border-secondary" placeholder="First name" name="u_fname"
                      type="text" value="<?php echo $parent_info['u_fname']; ?>" required minlength="3" maxlength="20"
                  ...
                  <div class="col-md-4 mb-3">
                    <input class="form-control border border-secondary" placeholder="Middle name" name="u_m_name"
                      type="text" value="<?php echo $parent_info['u_m_name']; ?>" required minlength="3" maxlength="20"
                      pattern="[A-Za-z\s]+" title="Only alphabetic characters are allowed">
                  </div>
                  <div class="col-md-4 mb-3">
                    <input class="form-control border border-secondary" placeholder="Last name" name="u_lname"
                      type="text" value="<?php echo $parent_info['u_lname']; ?>" required minlength="3" maxlength="20"
                      pattern="[A-Za-z\s]+" title="Only alphabetic characters are allowed">
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="input-group mb-4">
                      ...
                      <input class="form-control border border-secondary" id="contact_no" name="contact_no" type="text"
                        placeholder="9912367..." value="<?php echo $parent_info['contact_no']; ?>"
                  ...
                  <div class="col-md-8 mb-3">
                    <input class="form-control border border-secondary" id="email" name="email" type="text"
                      value="<?php echo $parent_info['email']; ?>" placeholder="Input gmail" required minlength="13"
                      maxlength="50">
                  </div>
                  ...
                  <div class="col-md-12 mb-4">
                    ...
                    <select name="relationship" id="relationshipSelect" class="form-control" required>
                      <option value="<?php echo $parent_info['relationship']; ?>" selected="">
                        <?php echo $parent_info['relationship']; ?>
                      </option>
                  ...
                  <div class="col-md-4 mb-3">
                    <input class="form-control border border-secondary" name="barangay" type="text"
                      value="<?php echo $parent_info['barangay']; ?>" placeholder="Input barangay" required
                      minlength="3" maxlength="30">
                  </div>
                  <div class="col-md-4 mb-3">
                    <input class="form-control border border-secondary" name="street" type="text"
                      value="<?php echo $parent_info['street']; ?>" placeholder="Input street or purok" required
                      minlength="3" maxlength="30">
                  </div>
                  <div class="col-md-4 mb-3">
                    <input class="form-control border border-secondary" name="city" type="text"
                      value="<?php echo $parent_info['city']; ?>" placeholder="Input city or municipality" required
                  ...
                  <div class="col-md-4 mb-3">
                    <input class="form-control border border-secondary" name="state" type="text"
                      value="<?php echo $parent_info['state']; ?>" placeholder="Input province" required minlength="3"
                  ...
                  <div class="col-md-4 mb-3">
                    <input class="form-control border border-secondary" name="zipcode" type="text"
                      value="<?php echo $parent_info['zipcode']; ?>" placeholder="Input zipcode" pattern="\d+"
