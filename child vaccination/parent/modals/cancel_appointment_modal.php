<div class="modal fade" id="cancel_app" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form id="cancel-appointment" action="includes/cancel_appointment.php" method="POST">
        <div class="modal-body">
          <p class="text-center">Are you sure you want to cancel your appointment?</p>
          <input type="text" class="form-control" name="cancel_reason" placeholder="Reason for cancellation" required
            minlength="4" maxlength="50">
        </div>
        <div class="modal-footer">
          <input type="hidden" name="appointment_id" value="<?php echo $upcoming_app['appointment_id']; ?>">
          <input type="hidden" name="appointment_date" value="<?php echo $upcoming_app['appointment_date']; ?>">
